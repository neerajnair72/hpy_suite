...
public class GoogleSheetAPI {
    ...
    *//**Application name
     ...
     * *//*
    private static final String APPLICATION_NAME = "HAT Framework Google Sheets API Data";
	...
	*//**
	 * Gets the spread sheet records.
	 *
	 * @param spreadsheetId the spreadsheet id
	 * @param range the range
	 * @return the spread sheet records
	 * @throws IOException Signals that an I/O exception has occurred.
	 *//*

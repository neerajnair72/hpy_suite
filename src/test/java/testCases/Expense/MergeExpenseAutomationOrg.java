...
@Feature("Expense")
public class MergeExpenseAutomationOrg  extends TestBotBase {
	Random rand= new Random();
	Double  doubleValue=rand.nextDouble()*10.0;
	Double amount= Math.round(doubleValue*100.00)/100.00;;
...
//		    7. Logout
		...
		pageGeneratorNew.GetInstance(LoginPage.class).loginAuto(excelUtils.getRowDataWithSheetName(1, "LoginOUP"))
		                               .gotoExpense()
		                               .clickAddExpens()                         
	...
	@Test(  dependsOnMethods="TC002_Expense_createExpenseformergeCab", priority = 3, description = "Verify the Auto Merge Expense icon is shown in expense list" )
	...
	public void TC003_Expense_AutoMergeExpenseIconinExpenseList() throws Exception {
	     ...
	     * 4. Compare the transaction id from
		 * file 
		 * 5. Logout
		 */
	 ...
	 * @throws Exception 
	 */
	@Test( dependsOnMethods="TC003_Expense_AutoMergeExpenseIconinExpenseList", priority = 4, description = "Verify Auto Merge Expense Bills" )
	 ...
	 * @throws Exception 
	 */
	@Test( dependsOnMethods="TC004_Expense_VerfiyAutoMergeExpenseDetailsBills", priority = 5, description = "Verify Auto Merge Expense Details" )
	@Severity(SeverityLevel.CRITICAL)
	 ...
	 * @throws Exception 
	 */
	@Test(  dependsOnMethods="TC005_Expense_VerfiyAutoMergeExpenseDetails",  priority = 6, description = "Verify the Un Merge Expense" )
	@Severity(SeverityLevel.TRIVIAL)
		 ...
		 */
		 ...
		 pageGeneratorNew.GetInstance(LoginPage.class).loginAuto(excelUtils.getRowDataWithSheetName(1, "LoginOUP"))
		 							    ...
		 							    //.Unmergeexpense(CreateExpensePage.UnMergeSuccess_Xpath,"1 transactions successfully unmerged from this transaction :")
		  								.Unmergeexpense("1 transactions successfully unmerged from this transaction :")
		  								.logout();
	}
	 ...
	 * @throws Exception 
	 */
	@Test(  dependsOnMethods="TC006_Expense_UnMerge",  priority = 7, description = "Verify Bills after unmerge" )
	@Severity(SeverityLevel.TRIVIAL)
	 ...
	 * @throws Exception 
	 */
	@Test( dependsOnMethods="TC007_Expense_VerifyBillsAfterUnMerge", priority = 8, description = "Verify the Merge Expense icon is shown in expense list" )
	@Severity(SeverityLevel.TRIVIAL)
...
//	    5. Logout
	...
	@Test(
			  ...
			  dependsOnMethods=
			  "TC010_Expense_MergeExpenseWithoutSelectingMergableTransaction",
			 
			 priority = 11, description = "Merge Expense" )
	@Severity(SeverityLevel.TRIVIAL)
...
//	    5. Logout
		 ...
		 pageGeneratorNew.GetInstance(LoginPage.class).loginAuto(excelUtils.getRowDataWithSheetName(1, "LoginOUP"))
		 								...
		 								.Unmergeexpense("2 transactions successfully unmerged from this transaction :")
		 								.logout();
	}

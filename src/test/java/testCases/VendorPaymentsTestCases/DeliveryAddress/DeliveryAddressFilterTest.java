...
@Epic("Delivery Address Filter Tests")
@Feature("Filter")
public class DeliveryAddressFilterTest extends TestBotBase{
	SoftAssert sa ;
	...
	public void testsetupbefore() throws Exception {
		pageGenerator.Login_VendorPage().get()
		                                ...
		                                .gotoAllFilters(ContainerElements_VendorPage.containerOptions.DELIVERY_ADDRESS);		                                		                                 		
	sa = new SoftAssert();		
	}	
	@AfterMethod
	...
	public void assertFilterValue(String Expected) {
		TestBotElementsWrapper.assertFilterData(pageGenerator.Filter_VendorPage().getFilterValueDelivery(), Expected);
	}
	@Test(priority=1)
	...
	public void TC_11_Apply_Filter_Test() throws Exception {
		...
		String Expected =pageGenerator.Filter_VendorPage().captureFilterValueTableViewDelivery();
		pageGenerator.Filter_VendorPage()
		                            .selectFilterFromTableDelivery();
		assertFilterValue(Expected);
		sa.assertAll();
	}

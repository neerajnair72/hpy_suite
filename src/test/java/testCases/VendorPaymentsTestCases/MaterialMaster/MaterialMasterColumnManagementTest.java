...
@Epic("MaterialMaster Mamage Column Tests")
@Feature("Manage Column")
public class MaterialMasterColumnManagementTest extends TestBotBase{
	 SoftAssert sa ;
	...
	public void testsetupbefore() throws Exception {
		pageGenerator.Login_VendorPage().get()
		                                ...
		                                .gotoManageColumn(ContainerElements_VendorPage.containerOptions.MATERIAL_MASTER);		                                		                                 		
	sa = new SoftAssert();		
	}	
	@AfterMethod
	...
	public void assertAllColumns() throws Exception {
		...
		TestBotElementsWrapper
		                    .assertAllColumns(pageGenerator.ManageColumn_VendorPage().getAllColumns(), ExcelUtils.getRowDataWithSheetName(4, "Vendor_ManageColumn"));
	}
   public void assertDefaultColumns() throws Exception {
		
		TestBotElementsWrapper
		                    .assertDefaultColumns(pageGenerator.ManageColumn_VendorPage().getAllColumns(), ExcelUtils.getRowDataWithSheetName(4, "Vendor_ManageColumn"));
	}  
   @Test(priority=1)
	@Severity(SeverityLevel.BLOCKER)
	@Description("Test Description-Deseelect a column and verify it in table view")
	@Story("Vendor payments smoke test")
	public void TC_08_Remove_Column_MaterialMaster_Test() throws Exception {
	...
	@Story("Vendor payments smoke test")
	public void TC_07_Add_Column_MaterialMaster_Test() throws Exception {
	...
	public void TC_10_SelectAll_Column_MaterialMaster_Test() throws Exception {
	...
	@Story("Vendor payments sanity test")
	public void TC_09_ResetToDefault_Column_MaterialMaster_Test() throws Exception {
